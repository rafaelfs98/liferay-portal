...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {testrayCaseResultByTestrayBuildIdTestrayBuild(comment: ___, commentBlankOnly: ___, error: ___, errorBlankOnly: ___, issues: ___, issuesBlankOnly: ___, page: ___, pageSize: ___, priority: ___, status: ___, testrayBuildId: ___, testrayCaseName: ___, testrayCaseTypeIds: ___, testrayComponentIds: ___, testrayRunId: ___, testrayRunName: ___, testrayTeamIds: ___, testrayUserId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
			...
			testrayCaseResultResource -> new TestrayCaseResultPage(
				testrayCaseResultResource.
					getTestrayCaseResultByTestrayBuildIdTestrayBuildPage(
						...
						errorBlankOnly, issues, issuesBlankOnly, priority,
