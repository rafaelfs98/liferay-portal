...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {testrayCaseResultByTestrayBuildIdTestrayBuild(comment: ___, error: ___, issues: ___, page: ___, pageSize: ___, priority: ___, status: ___, testrayBuildId: ___, testrayCaseName: ___, testrayCaseTypeIds: ___, testrayComponentIds: ___, testrayRunId: ___, testrayRunName: ___, testrayTeamIds: ___, testrayUserId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public TestrayCaseResultPage testrayCaseResultByTestrayBuildIdTestrayBuild(
			...
			testrayCaseResultResource -> new TestrayCaseResultPage(
				testrayCaseResultResource.
					getTestrayCaseResultByTestrayBuildIdTestrayBuildPage(
						testrayBuildId, comment, error, issues, priority,
						status, testrayCaseName, testrayCaseTypeIds,
						testrayComponentIds, testrayRunId, testrayRunName,
						testrayTeamIds, testrayUserId,
			...
			testrayCaseResultResource -> new TestrayCaseResultPage(
				testrayCaseResultResource.
					getTestrayCaseResultByTestrayCaseIdTestrayCasePage(
						...
						minExecutionDate, status, testrayProductVersionIds,
						testrayRoutineIds, testrayRunName, testrayTeamIds,
						testrayUserId, warning,
						Pagination.of(page, pageSize))));
	}
